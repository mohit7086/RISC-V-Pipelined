...
HD_PWD='M:/College/BTP/Vivado_Simulations/RISC_V Core/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_V_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISC_V_Top.tcl -notrace
