...
HD_PWD='M:/College/BTP/Vivado_Simulations/Execute/EX_Stage/EX_Stage.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ExecutionStage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ExecutionStage.tcl
