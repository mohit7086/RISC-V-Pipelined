...
HD_PWD='M:/College/BTP/Vivado_Simulations/Execute/EX_Stage/EX_Stage.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ExecutionStage.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ExecutionStage.tcl -notrace
