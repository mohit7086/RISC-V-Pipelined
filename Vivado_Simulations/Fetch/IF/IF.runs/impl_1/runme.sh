...
HD_PWD='M:/College/BTP/Vivado_Simulations/Fetch/IF/IF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FetchStage.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FetchStage.tcl -notrace
