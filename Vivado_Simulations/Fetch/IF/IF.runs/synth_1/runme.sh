...
HD_PWD='M:/College/BTP/Vivado_Simulations/Fetch/IF/IF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FetchStage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FetchStage.tcl
