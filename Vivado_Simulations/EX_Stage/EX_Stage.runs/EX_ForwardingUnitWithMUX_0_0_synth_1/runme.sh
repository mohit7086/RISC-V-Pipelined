...
HD_PWD='M:/College/BTP/Vivado_Simulations/EX_Stage/EX_Stage.runs/EX_ForwardingUnitWithMUX_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EX_ForwardingUnitWithMUX_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EX_ForwardingUnitWithMUX_0_0.tcl
